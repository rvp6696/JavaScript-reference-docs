...
console.log(Math.PI)
console.log(Math.round(100.76554))  // round off happens to nearest whole number 
console.log(Math.pow(2,3))   // same as exponential 
console.log(Math.sqrt(25))  // square root a number
...
console.log(Math.trunc(4.9))  // it returns only the integer part of a number
